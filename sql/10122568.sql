...
-- Dumping data for table rsupos_db_bk.category: ~11 rows (approximately)
...
-- Dumping data for table rsupos_db_bk.orderlist: ~1 rows (approximately)
INSERT INTO `orderlist` (`orderid`, `storeid`, `tableid`, `sessionid`, `productid`, `quantity`, `price`, `img`, `status`, `time`) VALUES
	(1, 1, 1, '75a9df85-2fc3-4251-bcde-fc7eca230067', 44, 1, 120.00, 'brownie', 'กำลังเตรียมอาหาร', '2025-12-09 18:36:01');
...
-- Dumping data for table rsupos_db_bk.orderlist_log: ~1 rows (approximately)
INSERT INTO `orderlist_log` (`log_id`, `orderid`, `storeid`, `sessionid`, `action`, `old_status`, `new_status`, `quantity`, `price`, `detail`, `created_at`) VALUES
	(1, 1, '1', '75a9df85-2fc3-4251-bcde-fc7eca230067', 'insert', NULL, 'กำลังเตรียมอาหาร', 1, 120.00, 'สร้างออเดอร์ใหม่', '2025-12-09 18:36:01');
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  CONSTRAINT `FK_product_category` FOREIGN KEY (`product_category`) REFERENCES `category` (`category_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FK_product_store` FOREIGN KEY (`product_storeid`) REFERENCES `store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=823322 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table rsupos_db_bk.product: ~31 rows (approximately)
...
-- Dumping data for table rsupos_db_bk.tableslist: ~12 rows (approximately)
INSERT INTO `tableslist` (`store_id`, `table_id`, `session_id`, `customer_amount`, `status`, `update_time`) VALUES
	(1, 1, '75a9df85-2fc3-4251-bcde-fc7eca230067', 0, 'waiting_for_bill', '2025-12-08 23:42:28'),
	(1, 2, '900950ee-7377-4f0c-b253-59076b4042db', 5, 'waiting_for_bill', '2025-12-03 21:34:59'),
	...
	(5, 1, NULL, 0, 'available', '2025-12-08 23:46:29'),
	(10, 6, NULL, 0, 'available', '2025-12-09 18:35:32'),
	(10, 1, NULL, 0, 'available', '2025-12-09 18:35:37');
