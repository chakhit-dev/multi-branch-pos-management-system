        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          ...
          <div className="w-full h-60 border flex justify-center items-center rounded-2xl bg-muted/50">
              <div className="flex flex-col items-center">
                ...
                <div className="text-7xl -my-4 font-semibold">{dataBranch.length ?? 0}</div>
          ...
          <div className="min-h-[100vh] flex-1 rounded-xl md:min-h-min">
            <div className="flex items-center justify-end py-4 gap-2">
              ...
              <AddBranch refreshData={fetchData} />
            </div>
            <TableRoundedCorner data={dataBranch} refreshData={fetchData} />
          </div>
        </div>
      </SidebarInset>
    </SidebarProvider>
