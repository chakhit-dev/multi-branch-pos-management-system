...
export default function CardKitchen({ data }: TableProps) {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger>
                <div className="relative bg-muted aspect-video rounded-xl flex flex-col justify-center items-center border-2">
                    ...
                    <div className="text-lg text-black/50 font-bold">
                        สถานะ <Badge variant="destructive"></Badge>
                    </div>
                </div>
            </DialogTrigger>
            <DialogContent>
                    ...
                    <DialogDescription asChild>
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex flex-col text-center gap-2">
                                <DialogClose asChild>
                                    <Button className="text-xl" variant="default">ส่งอาหารทั้งหมด</Button>
                                </DialogClose>
                                <DialogClose asChild>
